...
from semantic_sam.utils.constants import IMAGENET_CLASSES, IMAGENET_FOLDER_NAMES

__all__ = ["load_imagenet_images", "register_imagenet"]


def load_imagenet_images(dirname: str, split: str,
    ...
    for image_folder in image_folders:
        ...
        for img_pth in image_pths:
            r = {
                ...
                img_pth,
                "class_name":
                IMAGENET_CLASSES[IMAGENET_FOLDER_NAMES.index(folder_name)],
                "class_id":
